...
- **Source Text Manager** — Store and organize your texts, link them to generated audio
- **High-Quality Output** — 24 kHz, 16-bit WAV files ready for playback, editing, or publishing

---

## Plans

Six tiers from free to unlimited, with D&D-inspired names because that's how we roll.

| Tier | Price | Voices | Characters / Month | Commercial Use |
|------|-------|--------|-------------------|----------------|
| **Free** | $0 | 1 | 500 | No |
...
1. **Upload or paste your text** — Drop a `.txt` or `.md` file, or paste your content into the editor
2. **Choose your narrator** — Browse voices by category, preview them, and fine-tune speed and pitch
3. **Download your audio** — Hit generate and get a studio-quality WAV file, ready to play or share
